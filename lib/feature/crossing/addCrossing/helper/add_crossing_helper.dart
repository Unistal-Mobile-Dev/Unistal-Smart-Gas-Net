...
class AddCrossingHelper {
  ...
  static Future<dynamic> submitData({required BuildContext context,
    ...
    required String weldingReportNumber,
    required String radiographyReportNo,
    required String hddWithCashing,
    required String locationName,
    required String holidayTestNo,
    required String coatingReportNo,
    required String preHydroReportNo,
    required String onBody,
    required String hddSectionPreparation,
    required String casingLength,
    ...
    try{
      ...
      var json = {
        ...
        "crossing_type_id" : crossingTypeData.id != null ? crossingTypeData.id.toString() : "0",
        "welding_report_no": weldingReportNumber,
        "rediography_report_no": radiographyReportNo,
        "hdd_section_prep": hddSectionPreparation,
        "hdd_casing_length": hddWithCashing,
        "casing_length": casingLength,
        "coating_report_no": coatingReportNo,
        "holiday_checking": holidayChecksData.id != null ? holidayChecksData.id.toString() : "0",
        "pre_padding_checking": prePaddingData.id != null ? prePaddingData.id.toString() : "0",
        "post_padding_checking": postPaddingData.id != null ? postPaddingData.id.toString() : "0",
        "activity_remarks": activityRemark,
        "pre_hydrotest_report_no": preHydroReportNo,
