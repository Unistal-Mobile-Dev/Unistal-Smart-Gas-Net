...
class AddLevellingHelper {
  ...
  static Future<dynamic> submitData({required BuildContext context,
    ...
    required String gpsCoordinateNorth,
    required String gpsCoordinateEast,
    required String elevationPipetop,
    required String natureGroundLeve,
    ...
    try{
      ...
      String url =  APIs.addLevellingApi;
      var json = {
        "user_id" : userData.userId.toString(),
        "schema": userData.schema.toString(),
        "spread_id": userData.spreadId.toString(),
        "section_id": userData.sectionId.toString(),
        "chainage_from" : chainageFrom.toString(),
