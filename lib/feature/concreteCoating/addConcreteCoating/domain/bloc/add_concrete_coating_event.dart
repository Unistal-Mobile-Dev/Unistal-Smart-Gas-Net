...
class AddConcreteCoatingSelectSelectThicknessDataEvent extends AddConcreteCoatingEvent {
  final ThicknessModel thicknessData;
  const AddConcreteCoatingSelectSelectThicknessDataEvent({required this.thicknessData});
  @override
...
class AddConcreteCoatingAddImageEvent extends AddConcreteCoatingEvent {
  final BuildContext context;
  final int mediaType;
  const AddConcreteCoatingAddImageEvent({required this.context, required this.mediaType});
  @override
...
class AddConcreteCoatingAddSearchPipeDataEvent extends AddConcreteCoatingEvent {
  ...
  const AddConcreteCoatingAddSearchPipeDataEvent({required this.context, required this.keyword});
  @override
