  ...
  Widget _alignmentDropdown({required FetchAddHddCrossingDataState dataState}) {
    return DropDownSearchMultiSelectWidget(
      ...
      onChanged: (value) {
        ...
        BlocProvider.of<AddHddCrossingBloc>(context)
            .add(AddHddCrossingMultipleSelectAlignmentEvent(
  ...
  Widget _photo({required FetchAddHddCrossingDataState dataState}){
    return PhotoUploadWidget(
      ...
      onTap: () => MediaPickerSheet.show(
        context: context,
        onCamera: () => BlocProvider.of<AddHddCrossingBloc>(context).add(
            AddHddCrossingAddImageEvent(
                context: context, mediaType: 1)),
        onGallery: () =>BlocProvider.of<AddHddCrossingBloc>(context).add(
            AddHddCrossingAddImageEvent(
