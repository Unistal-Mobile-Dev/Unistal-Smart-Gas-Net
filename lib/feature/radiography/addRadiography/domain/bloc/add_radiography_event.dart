...
class AddRadiographySelectInspectionEvent extends AddRadiographyEvent {
  final TerrainTypeModel inspectionVal;

  const AddRadiographySelectInspectionEvent({required this.inspectionVal});

  @override
  List<Object?> get props => [inspectionVal];
}

class AddRadiographyMultipleSelectAlignmentEvent extends AddRadiographyEvent {
  final List<AlignmentModel> alignmentData;

  const AddRadiographyMultipleSelectAlignmentEvent(
...
class AddRadiographySelectJointTypeDataEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectJointTypeDataEvent(
...
class AddRadiographySelectJointNumberDataEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectJointNumberDataEvent({
...
class AddRadiographySelectSegmentDataEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectSegmentDataEvent(
...
class AddRadiographyAddImageEvent extends AddRadiographyEvent {
  ...
  const AddRadiographyAddImageEvent(
...
class AddRadiographySelectWelderDataEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectWelderDataEvent(
      {required this.index,
...
class AddRadiographySelectHotPassWelderEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectHotPassWelderEvent(
      {required this.index, required this.welderData});
...
class AddRadiographySelectFillerWelderEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectFillerWelderEvent(
      {required this.index, required this.welderData});
...
class AddRadiographySelectCappingWelderEvent extends AddRadiographyEvent {
  ...
  const AddRadiographySelectCappingWelderEvent(
      {required this.index, required this.welderData});
