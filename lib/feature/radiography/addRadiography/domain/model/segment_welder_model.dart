...
List<SegmentWelderModel> segmentWelderListResponse(var json, List<WelderModel> welderList) {
  return List<SegmentWelderModel>.from(json.map((x) => SegmentWelderModel.fromJson(x, welderList)));
}
...
class SegmentWelderModel {
    ...
    factory SegmentWelderModel.fromJson(Map<String, dynamic> json, List<WelderModel> welderList) {
