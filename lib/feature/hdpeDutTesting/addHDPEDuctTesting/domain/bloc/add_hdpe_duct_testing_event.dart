...
class AddHdpeDuctTestingSelectFromJointDataEvent
    extends AddHdpeDuctTestingEvent {
  final JointNumberModel jointNumberData;

  const AddHdpeDuctTestingSelectFromJointDataEvent(
...
class AddHdpeDuctTestingSelectJointTypeDataEvent
    extends AddHdpeDuctTestingEvent {
  final JointTypeModel jointTypeData;
  final BuildContext context;

  const AddHdpeDuctTestingSelectJointTypeDataEvent(
...
class AddHdpeDuctTestingSelectToJointDataEvent extends AddHdpeDuctTestingEvent {
  ...
  const AddHdpeDuctTestingSelectToJointDataEvent(
      {required this.jointNumberData});
...
class AddHdpeDuctTestingAddImageEvent extends AddHdpeDuctTestingEvent {
  ...
  const AddHdpeDuctTestingAddImageEvent(
