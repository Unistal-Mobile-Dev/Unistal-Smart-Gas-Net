...
class AddNdtAutSelectWPSTypeEvent extends AddNdtAutEvent {
  ...
  final BuildContext context;
  const AddNdtAutSelectWPSTypeEvent({required this.wpsTypeData, required this.context});
  @override
...
class AddNdtAutSelectJointTypeEvent extends AddNdtAutEvent {
  ...
  final BuildContext context;
  const AddNdtAutSelectJointTypeEvent({required this.jointTypeModel, required this.context});
  @override
...
class AddNdtAutAddImageEvent extends AddNdtAutEvent {
  final BuildContext context;
  final int mediaType;
  const AddNdtAutAddImageEvent({required this.context, required this.mediaType});
  @override
