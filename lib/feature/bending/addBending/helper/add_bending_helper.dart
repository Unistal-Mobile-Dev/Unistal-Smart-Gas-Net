...
class AddBendingHelper {
  ...
  static Future<dynamic> submitData({
    ...
    try {
      ...
      var json = {
        ...
        "visual_checks": visualChecksData.id == null ? "" : visualChecksData.id.toString(),
        "gauging_checks": gaugingCheckData.id == null ? "" : gaugingCheckData.id.toString(),
        "disbomdment_checks": disbomdmentCheckData.id == null ? "" : disbomdmentCheckData.id.toString(),
        "holiday_checks": holidayChecksData.id == null ? "" : holidayChecksData.id.toString(),
        "bend_no": bendNumber,
        "bend_type_id": bendingTypeData.id == null ? "" : bendingTypeData.id.toString(),
  ...
  static Future<dynamic> fetchBendingType() async {
