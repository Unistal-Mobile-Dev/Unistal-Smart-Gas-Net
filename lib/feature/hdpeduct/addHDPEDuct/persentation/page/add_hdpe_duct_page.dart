...
class _AddHdpeDuctPageState extends State<AddHdpeDuctPage> {
  ...
  @override
  void initState() {
    BlocProvider.of<AddHdpeDuctBloc>(context).add(AddHdpeDuctPageLoadEvent(context: context));
    super.initState();
  }
    ...
    return TextFieldWidget(
      ...
      onTap: () {
        BlocProvider.of<AddHdpeDuctBloc>(context).add(
            AddHdpeDuctSelectDateEvent(context: context,));
      },
    );
  }
  ...
  Widget _jointTypeDropDown({required FetchAddHdpeDuctDataState dataState}) {
    return DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddHdpeDuctBloc>(context).add(
            AddHdpeDuctSelectJointTypeDataEvent(jointTypeData: value, context: context));
      },
  ...
  Widget _fromJointNumberDropDown({required FetchAddHdpeDuctDataState dataState}) {
  ...
  Widget _toJointNumberDropDown({required FetchAddHdpeDuctDataState dataState}) {
    return dataState.isJointNumberLoader == false ?
    DropdownWidget(
          ...
          child: Column(
            children: [
              TextButton(onPressed: () {
                BlocProvider.of<AddHdpeDuctBloc>(context).add(AddHdpeDuctAddImageEvent(context: context, mediaType: 1));
              }, child: TextWidget("Camera", fontSize: AppFont.font_16,)),
              const Divider(),
              TextButton(onPressed: () {
                BlocProvider.of<AddHdpeDuctBloc>(context).add(AddHdpeDuctAddImageEvent(context: context, mediaType: 2));
