...
class _AddTrenChingPageState extends State<AddTrenChingPage> {
    ...
    return TextFieldWidget(
      ...
      onTap: () {
        BlocProvider.of<AddTrenChingBloc>(context).add(
            AddTrenChingSelectDateEvent(context: context,));
      },
    );
  }
  ...
  Widget _alignmentDropdown({required FetchAddTrenChingDataState dataState}) {
    return  DropDownSearchWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddTrenChingBloc>(context).add(
            AddTrenChingSelectAlignmentEvent(alignmentData: value,));
      },
    );
  }
  ...
  Widget _terrainTypeController({required FetchAddTrenChingDataState dataState}) {
    return TextFieldWidget(
      isRequired: true,
