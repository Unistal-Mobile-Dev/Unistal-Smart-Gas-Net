...
class ForgotPasswordBloc extends Bloc<ForgotPasswordEvent, ForgotPasswordState> {
  ...
  _submitEvent(ForgotPasswordSubmitEvent event, emit) async {
      _isLoader =  true;
      _eventCompleted(emit);
      var res =  await ForgotPasswordHelper.submitEmailOnServer(email: emailTextFieldController.text.toString(),
  ...
  _eventCompleted(Emitter<ForgotPasswordState> emit) {
    emit(FetchForgotPasswordDataState(isLoader: isLoader, emailTextFieldController: emailTextFieldController));
  }
}
