...
class _AddWeldingPageState extends State<AddWeldingPage> {
    ...
    return TextFieldWidget(
      ...
      onTap: () {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectDateEvent(context: context,));
      },
    );
  }

  Widget _reportNumberController({required FetchAddWeldingDataState dataState}) {
    return TextFieldWidget(
      isRequired: true,
  ...
  Widget _rootWelders2Dropdown({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.rootWelders2));
      },
  ...
  Widget _hotWelders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.hotWelders1));
      },
  ...
  Widget _hotWelders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.hotWelders2));
      },
  ...
  Widget _filler1Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler1Welders1));
      },
  ...
  Widget _filler1Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler1Welders2));
      },
  ...
  Widget _filler2Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler2Welders1));
      },
  ...
  Widget _filler2Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler2Welders2));
      },
  ...
  Widget _filler3Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler3Welders1));
      },
  ...
  Widget _filler3Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler3Welders2,
      dropdownValue: dataState.filler3Welders2Data.id != null ? dataState.filler3Welders2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler3Welders2));
      },
  ...
  Widget _filler4Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler4Welders1,
      dropdownValue: dataState.filler4Welders1Data.id != null ? dataState.filler4Welders1Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler4Welders1));
      },
  ...
  Widget _filler4Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler4Welders2,
      dropdownValue: dataState.filler4Welders2Data.id != null ? dataState.filler4Welders2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler4Welders2));
      },
  ...
  Widget _filler5Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler5Welders1,
      dropdownValue: dataState.filler5Welders1Data.id != null ? dataState.filler5Welders1Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler5Welders1));
      },
  ...
  Widget _filler5Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler5Welders2,
      dropdownValue: dataState.filler5Welders2Data.id != null ? dataState.filler5Welders2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler5Welders2));
      },
  ...
  Widget _filler6Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler6Welders1,
      dropdownValue: dataState.filler6Welders1Data.id != null ? dataState.filler6Welders1Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler6Welders1));
      },
  ...
  Widget _filler6Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler6Welders2,
      dropdownValue: dataState.filler6Welders2Data.id != null ? dataState.filler6Welders2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler6Welders2));
      },
  ...
  Widget _filler7Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler7Welders1,
      dropdownValue: dataState.filler7Welders1Data.id != null ? dataState.filler7Welders1Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler7Welders1));
      },
  ...
  Widget _filler7Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler7Welders2,
      dropdownValue: dataState.filler7Welders2Data.id != null ? dataState.filler7Welders2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler7Welders2));
      },
  ...
  Widget _filler8Welders1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler8Welders1,
      dropdownValue: dataState.filler8Welders1Data.id != null ? dataState.filler8Welders1Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler8Welders1));
      },
  ...
  Widget _filler8Welders2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.filler8Welders2,
      dropdownValue: dataState.filler8Welders2Data.id != null ? dataState.filler8Welders2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.filler8Welders2));
      },
  ...
  Widget _stripWelder1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.stripWelder1,
      dropdownValue: dataState.stripWelder1Data.id != null ? dataState.stripWelder1Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.stripWelder1));
      },
  ...
  Widget _stripWelder2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      hint: AppString.stripWelder2,
      dropdownValue: dataState.stripWelder2Data.id != null ? dataState.stripWelder2Data : null,
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.stripWelder2));
      },
  ...
  Widget _cappingWelder1Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.cappingWelder1));
      },
  ...
  Widget _cappingWelder2Controller({required FetchAddWeldingDataState dataState}) {
    return  DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectMultiWelderEvent(welderData: value, name: AppString.cappingWelder2));
      },
  ...
  Widget _wpsDropDown({required FetchAddWeldingDataState dataState}) {
    return DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectWPSEvent(wpsData: value, context: context));
      },
  ...
  Widget _jointTypeDropDown({required FetchAddWeldingDataState dataState}) {
    return DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectJointTypeEvent(jointTypeData: value, context: context));
      },
  ...
  Widget _weldVisualDropDown({required FetchAddWeldingDataState dataState}) {
    return DropdownWidget(
      ...
      onChanged: (value) {
        BlocProvider.of<AddWeldingBloc>(context).add(
            AddWeldingSelectWeldVisualEvent(weldVisualData: value));
      },
          ...
          child: Column(
            children: [
              TextButton(onPressed: () {
                BlocProvider.of<AddWeldingBloc>(context).add(AddWeldingAddImageEvent(context: context, mediaType: 1));
              }, child: TextWidget("Camera", fontSize: AppFont.font_16,)),
              const Divider(),
              TextButton(onPressed: () {
                BlocProvider.of<AddWeldingBloc>(context).add(AddWeldingAddImageEvent(context: context, mediaType: 2));
