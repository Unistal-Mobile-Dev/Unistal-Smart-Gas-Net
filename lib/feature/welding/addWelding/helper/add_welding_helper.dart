  ...
  static Future<dynamic> textFiledValidation({
    ...
    try {
      if (date.isEmpty) {
        ...
        SnackBarErrorWidget(context)
            .show(message: "Please Select joint number");
        return false;
      } else if (leftPipeNumber.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter left pipe number");
        return false;
      } else if (rightPipeNumber.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter right pipe number");
        return false;
      } else if (electrodeDiaE6010.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E6010");
        return false;
      } else if (electrodeDiaE6010Batch.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E6010 Batch");
        return false;
      } else if (electrodeEiaE8010p1.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E8010p1");
        return false;
      } else if (electrodeEiaE8010p1Batch.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E8010p1 Batch");
        return false;
      } else if (electrodeDiaE9045p2.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E9045p2");
        return false;
      } else if (electrodeDiaE9045p2Batch.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E9045p2 Batch");
        return false;
      } else if (electrodeDiaE81t8g.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E81t8g");
        return false;
      } else if (electrodeDiaE81t8gBatch.isEmpty) {
        SnackBarErrorWidget(context)
            .show(message: "Please enter electrode Dia E81t8g Batch");
        return false;
  ...
  static Future<dynamic> submitData({
    ...
    try {
      ...
      var json = {
        ...
        "filler1_welder_one": filler1Welders1Data.id != null ? filler1Welders1Data.id : "",
        "filler1_welder_two": filler1Welders2Data.id != null ? filler1Welders2Data.id : "",
        "filler2_welder_one": filler2Welders1Data.id != null ? filler2Welders1Data.id : "",
        "filler2_welder_two": filler2Welders2Data.id != null ? filler2Welders2Data.id : "",
        "filler3_welder_one": filler3Welders1Data.id != null ? filler3Welders1Data.id : "",
        "filler3_welder_two": filler3Welders2Data.id != null ? filler3Welders2Data.id : "",
        "filler4_welder_one": filler4Welders1Data.id != null ? filler4Welders1Data.id : "",
        "filler4_welder_two": filler4Welders2Data.id != null ? filler4Welders2Data.id : "",
        "filler5_welder_one": filler5Welders1Data.id != null ? filler5Welders1Data.id : "",
        "filler5_welder_two": filler5Welders2Data.id != null ? filler5Welders2Data.id : "",
        "filler6_welder_one": filler6Welders1Data.id != null ? filler6Welders1Data.id : "",
        "filler6_welder_two": filler6Welders2Data.id != null ? filler6Welders2Data.id : "",
        "filler7_welder_one": filler7Welders1Data.id != null ? filler7Welders1Data.id : "",
        "filler7_welder_two": filler7Welders2Data.id != null ? filler7Welders2Data.id : "",
        "filler8_welder_one": filler8Welders1Data.id != null ? filler8Welders1Data.id : "",
        "filler8_welder_two": filler8Welders2Data.id != null ? filler8Welders2Data.id : "",
        ...
        "electrode_dia_e8010p1": electrodeEiaE8010p1.isNotEmpty ? electrodeEiaE8010p1 : "",
        "electrode_dia_e8010p1_batch": electrodeEiaE8010p1Batch.isNotEmpty ? electrodeEiaE8010p1Batch : "",
        "electrode_dia_e9045p2": electrodeDiaE9045p2.isNotEmpty ? electrodeDiaE9045p2 : "",
        "electrode_dia_e9045p2_batch": electrodeDiaE9045p2Batch.isNotEmpty ? electrodeDiaE9045p2Batch : "",
        "electrode_dia_e81t8g": electrodeDiaE81t8g.isNotEmpty ? electrodeDiaE81t8g : "",
        "electrode_dia_e81t8g_batch": electrodeDiaE81t8gBatch.isNotEmpty ? electrodeDiaE81t8gBatch : "",
