...
class AddWelderRepairSelectWPSTypeEvent extends AddWelderRepairEvent {
  ...
  final BuildContext context;
  const AddWelderRepairSelectWPSTypeEvent({required this.wpsTypeData, required this.context});
  @override
...
class AddWelderRepairSelectWelderRepairStatusEvent extends AddWelderRepairEvent {
  final WelderRepairStatusModel  welderRepairStatusData;
  const AddWelderRepairSelectWelderRepairStatusEvent({required this.welderRepairStatusData});
  @override
...
class AddWelderRepairSelectJointTypeEvent extends AddWelderRepairEvent {
  ...
  final BuildContext context;
  const AddWelderRepairSelectJointTypeEvent({required this.jointTypeModel, required this.context});
  @override
...
class AddWelderRepairAddImageEvent extends AddWelderRepairEvent {
  final BuildContext context;
  final int mediaType;
  const AddWelderRepairAddImageEvent({required this.context, required this.mediaType});
  @override
