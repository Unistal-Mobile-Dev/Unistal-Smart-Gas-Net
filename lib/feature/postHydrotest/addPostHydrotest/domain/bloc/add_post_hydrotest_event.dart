...
class AddPostHydrotestSelectFromJointDataEvent extends AddPostHydrotestEvent {
  ...
  const AddPostHydrotestSelectFromJointDataEvent({required this.jointNumberData});
  @override
...
class AddPostHydrotestSelectJointTypeDataEvent extends AddPostHydrotestEvent {
  ...
  final BuildContext context;
  const AddPostHydrotestSelectJointTypeDataEvent({required this.jointTypeData, required this.context});
  @override
...
class AddPostHydrotestAddImageEvent extends AddPostHydrotestEvent {
  final BuildContext context;
  final int mediaType;
  const AddPostHydrotestAddImageEvent({required this.context, required this.mediaType});
  @override
