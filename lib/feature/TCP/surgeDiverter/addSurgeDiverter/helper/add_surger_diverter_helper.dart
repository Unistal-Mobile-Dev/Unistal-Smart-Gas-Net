...
class AddSurgerDiverterHelper{
  ...
  static Future<dynamic> submitData(
    {required BuildContext context,
      ...
      required String acVolatgePolarisationCheck,
      required String psp,
  ...
  try {
    ...
    String url = APIs.addSurgeDiverterInsertApi;
    var json = {
      ...
      "ac_volatge_polarisation_check": acVolatgePolarisationCheck.toString(),
      "psp": psp.toString(),
