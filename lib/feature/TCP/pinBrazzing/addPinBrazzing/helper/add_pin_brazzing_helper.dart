...
class AddPinBrazzingHelper{
  ...
  static Future<dynamic> submitData(
    {required BuildContext context,
      ...
      required String contactRegistance,
      ...
      required VisualChecksModel ponBrazzingConnection,
      required File file
    }) async {
  try {
    ...
    String url = APIs.addPinBrazzingInsertApi;
    var json = {
      ...
      "contact_registance": contactRegistance.toString(),
      ...
      "pon_brazzing_connection": ponBrazzingConnection.id != null ? ponBrazzingConnection.id.toString() : "",
