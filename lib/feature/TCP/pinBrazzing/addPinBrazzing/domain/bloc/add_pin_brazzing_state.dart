...
@immutable
abstract class AddPinBrazzingState extends Equatable{}

final class AddPinBrazzingInitial extends AddPinBrazzingState {
  @override
...
class AddPinBrazzingPageLoadState extends AddPinBrazzingState {
  @override
  List<Object> get props => [];
}

class FetchAddPinBrazzingState extends AddPinBrazzingState {
  final File file;
  final bool isLoader;
