...
part 'add_pin_brazzing_event.dart';
part 'add_pin_brazzing_state.dart';

class AddPinBrazzingBloc extends Bloc<AddPinBrazzingEvent, AddPinBrazzingState> {
  AddPinBrazzingBloc() : super(AddPinBrazzingInitial()) {
    on<AddPinBrazzingPageLoadEvent>(_pageLoadEvent);
    on<AddPinBrazzingSelectDateEvent>(_selectDate);
  ...
  _pageLoadEvent(AddPinBrazzingPageLoadEvent event, emit) async {
    emit(AddPinBrazzingPageLoadState());
    isLoader = false;
    file = File("");
    dateController.text = "";
    areaController.text = "";
  ...
  _selectAlignment(AddPinBrazzingSelectAlignmentEvent event, emit) {
  ...
  _selectDate(AddPinBrazzingSelectDateEvent event, emit) async {
  ...
  _selectFile(AddPinBrazzingAddImageEvent event, emit) async {
