...
class AddHydrotestSelectJointTypeDataEvent extends AddHydrotestEvent {
  ...
  final BuildContext context;
  const AddHydrotestSelectJointTypeDataEvent({required this.jointTypeData, required this.context});
  @override
...
class AddHydrotestAddImageEvent extends AddHydrotestEvent {
  ...
  final int mediaType;
  final int index;
  const AddHydrotestAddImageEvent({required this.context, required this.mediaType, required this.index});
  @override
